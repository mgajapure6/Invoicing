					...
					<div class="itemFound hide mg-t-20">
						<div class="row row-sm">
							<div class="col-sm mg-t-0">
								<span class="fieldSuggestionTxt">
									Avai. Qty :
									<span class="fieldSuggestionQty"></span>
									<span class="fieldSuggestionUnit"></span>
								</span>
							...
							<div class="col-sm mg-t-0">
								<span class="fieldSuggestionTxt">
									Orig. Unit Price : Rs
									<span class="fieldSuggestionUnitPrice"></span>
								</span>
						...
						<div class="modalTotDiv mg-t-10" style="text-align: right;">
							<p class="">
								Total Amount : Rs
								<b class="modalTotAmt">0.00</b>
							</p>
							<p class="">
								Tax Amount : Rs
								<b class="modalTotTaxAmt">0.00</b>
							</p>
							<p class="">
								Discount Amount : Rs
								<b class="modalDiscountAmt">0.00</b>
							</p>
							<p class="">
								Grand Total Amount : Rs
								<b class="modalGrandTotAmt">0.00</b>
							</p>
						</div>
						<div class="row row-sm">
