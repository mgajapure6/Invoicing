				...
				<div class="col-md-5">
					<div class="form-control-like-div bottom-total-group">
						<div class="d-flex" style="align-items: center;">
							...
							<div class="mg-l-auto">
								<b>Rs :</b>
								<b class="invoiceMainTotAmt">0.00</b>
							</div>
						</div>
						<hr style="margin: 3px">
						<div class="d-flex" style="align-items: center;">
							...
							<div class=" mg-l-auto">
								<b>Rs :</b>
								<b class="invoiceMainDisAmt">0.00</b>
							</div>
						</div>
						<hr style="margin: 3px">
						<div class="d-flex" style="align-items: center;">
							...
							<div class=" mg-l-auto">
								<b>Rs :</b>
								<b class="invoiceMainTaxableAmt">0.00</b>
							</div>
						</div>
						<hr style="margin: 3px">
						<div class="d-flex" style="align-items: center;">
							...
							<div class=" mg-l-auto">
								<b>Rs :</b>
								<b class="invoiceMainTaxAmt">0.00</b>
							</div>
						</div>
						<hr style="margin: 3px">
						<div class="d-flex" style="align-items: center;">
							...
							<div class=" mg-l-auto">
								<b>Rs :</b>
								<b class="invoiceMainGrandAmt">0.00</b>
							</div>
						</div>
					</div>
				</div>
