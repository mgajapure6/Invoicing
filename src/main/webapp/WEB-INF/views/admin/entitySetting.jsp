...
<body>
	<div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
		...
		<div class="d-none d-md-block">
			...
			<button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 listToFormBtn">
				...
				<span class="spinner-border spinner-border-sm hide spinIcon mg-r-5" role="status" aria-hidden="true"></span> <span>All Entities</span>
			</button>
		</div>
	</div>
	...
	<div data-label="List Of Entities" class="df-example demo-table hide">
		...
		$('.listToFormBtn').on('click', function() {
			...
			setTimeout(function() {
				if ($('.demo-table').hasClass('hide')) {
					...
					$(this).find('span').text('All Entities')
				}

				$('.listToFormBtn').find('.spinIcon').addClass('hide');
				$('.listToFormBtn').find('svg').removeClass('hide');
			}, 500);
