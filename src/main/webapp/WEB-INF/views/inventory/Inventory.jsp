						...
						<tbody>
							<c:forEach items="${allItems}" var="itm">
								<tr>
									...
									<td class="">
										<span class="itemId hide">${itm.id}</span>
										<span class="categoryId hide">${itm.itemCategory.id}</span>
										<span class="lowStockQty hide">${itm.lowStockQty}</span>
						...
						<tbody>
							<c:forEach items="${allCategories}" var="cat">
								<tr>
									...
									<td class="">
										<span class="categoryId hide">${cat.id}</span>
										<div class="text-center">
