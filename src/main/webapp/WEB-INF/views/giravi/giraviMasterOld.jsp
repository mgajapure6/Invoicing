		...
		<div class="card-body">
			<form id="giraviMasterForm">
				...
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							<label for="loanAmt">Loan/Principle Amount</label> <input type="text" class="form-control form-control-sm" placeholder="Enter Loan/Principle Amount" id="loanAmt" name="loanAmt">
						</div>
					</div>

					<div class="col-md-3">
						<div class="form-group">
							<label for="loanStartDate">Loan Start Date</label> <input type="text" class="form-control form-control-sm" placeholder="Select Loan Start Date" id="loanStartDate" name="loanStartDate">
						</div>
					</div>

					<div class="col-md-3">
						<div class="form-group">
							<label for="loanDuration">Loan Duration Type</label> <select class="form-control form-control-sm" id="loanDuration" name="loanDuration">
					...
					<div class="col-md-3">
						<div class="form-group">
							<label for="rateOfIn">Rate Of Interest</label> <select class="form-control form-control-sm" id="rateOfIn" name="rateOfIn">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="phone">Phone Number</label> <input type="tel" class="form-control form-control-sm" id="phone" name="phone" placeholder="phone">
						</div>
					</div>
