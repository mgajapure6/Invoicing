				...
				<div class="modal-body pd-sm-x-30">
					...
					<div class="row row-sm mg-t-10">
						<div class="col-sm mg-t-0">
							<label class="tx-10 tx-uppercase tx-medium tx-spacing-1 mg-b-0 tx-color-03">Select Metal</label> <select onkeyup="" class="form-control metalSelect">
					...
					<div class="row row-sm mg-t-10">
						...
						<div class="col-sm mg-t-0">
							<label class="tx-10 tx-uppercase tx-medium tx-spacing-1 mg-b-0 tx-color-03">Gross Weight Unit</label> <select class="form-control guomSelect">
								<option value="gm" selected>Gram</option>
								<option value="mg">MiliGram</option>
							</select>
						</div>
						<div class="col-sm mg-t-0">
							<label class="tx-10 tx-uppercase tx-medium tx-spacing-1 mg-b-0 tx-color-03 mandlabel">Net Weight</label> <input type="text" class="form-control right mandatory netWeightInput netWeightCleave" required placeholder="Enter Net Weight" data-parsley-trigger="keyup" data-parsley-minlength="1" data-parsley-validation-threshold="0" data-parsley-maxlength="10" data-parsley-minlength-message="Enter proper weight. ">

						</div>
						<div class="col-sm mg-t-0">
							<label class="tx-10 tx-uppercase tx-medium tx-spacing-1 mg-b-0 tx-color-03">Net Weight Unit</label> <select class="form-control nuomSelect">
								<option value="gm" selected>Gram</option>
								<option value="mg">MiliGram</option>
							</select>
						</div>
					...
					<div class="row row-sm mg-t-10">
						<div class="col-sm mg-t-0">
							<label class="tx-10 tx-uppercase tx-medium tx-spacing-1 mg-b-0 tx-color-03">Valuation Amount</label> <input type="text" class="form-control right valuationInput valuationCleave" placeholder="Enter Valuation Amount">
						</div>
						<div class="col-sm mg-t-0">
