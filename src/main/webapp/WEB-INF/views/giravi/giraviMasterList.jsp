	...
	<div class="row giraviTable ">
		<div class="col-md-12">
			<ul class="nav nav-line" id="myTab6" role="tablist">
				...
				<li class="float-right" style="margin-left: auto;"><a href="javascript:;" style="float: right;" data-flag="N" onclick="viewGiraviFormNew(this)" class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5">
