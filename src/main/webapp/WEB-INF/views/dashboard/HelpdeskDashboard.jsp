			...
			<div class="card">
				<div class="card-header d-sm-flex justify-content-between bd-b-0 pd-t-20 pd-b-0">
					...
					<ul class="list-inline tx-uppercase tx-10 tx-medium tx-spacing-1 tx-color-03 mg-b-0">
						<li class="list-inline-item"><span class="d-inline-block wd-7 ht-7 bg-gray-400 rounded-circle mg-r-5"></span> New<span class="d-none d-md-inline"> Tickets</span></li>
						<li class="list-inline-item mg-l-10"><span class="d-inline-block wd-7 ht-7 bg-df-2 rounded-circle mg-r-5"></span> Solved<span class="d-none d-md-inline"> Tickets</span></li>
						<li class="list-inline-item mg-l-10"><span class="d-inline-block wd-7 ht-7 bg-primary rounded-circle mg-r-5"></span> Open<span class="d-none d-md-inline"> Tickets</span></li>
					</ul>
				</div>
				<div class="card-body">
						...
						<div class="media d-block d-sm-flex align-items-center">
							...
							<div class="media-body mg-t-20 mg-sm-t-0 mg-sm-l-20">
								...
								<h3 class="tx-spacing--1 mg-b-0">
									7m:32s <small class="tx-13 tx-color-03">/ Goal: 8m:0s</small>
								</h3>
							</div>
							<!-- media-body -->
						</div>
					...
					<div class="card card-body">
						<div class="media d-block d-sm-flex align-items-center">
							...
							<div class="media-body mg-t-20 mg-sm-t-0 mg-sm-l-20">
								...
								<h3 class="tx-spacing--1 mg-b-0">
									0m:20s <small class="tx-13 tx-color-03">/ Goal: 0m:10s</small>
								</h3>
							</div>
							<!-- media-body -->
						</div>
