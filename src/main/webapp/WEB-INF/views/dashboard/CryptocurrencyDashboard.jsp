						...
						<div id="flotChart1" class="flot-chart" style="padding: 0px; position: relative;">
							...
							<div class="flot-text" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; font-size: smaller; color: rgb(84, 84, 84);">
								...
								<div class="flot-y-axis flot-y1-axis yAxis y1Axis" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px;">
									<div style="position: absolute; top: 261px; font: 400 10px/12px&amp; quot; IBM Plex Sans&amp;quot; , sans-serif; color: rgb(131, 146, 165); left: 11px; text-align: right;">0</div>
									<div style="position: absolute; top: 180px; font: 400 10px/12px&amp; quot; IBM Plex Sans&amp;quot; , sans-serif; color: rgb(131, 146, 165); left: 6px; text-align: right;">50</div>
									<div style="position: absolute; top: 99px; font: 400 10px/12px&amp; quot; IBM Plex Sans&amp;quot; , sans-serif; color: rgb(131, 146, 165); left: 0px; text-align: right;">100</div>
									<div style="position: absolute; top: 18px; font: 400 10px/12px&amp; quot; IBM Plex Sans&amp;quot; , sans-serif; color: rgb(131, 146, 165); left: 0px; text-align: right;">150</div>
								</div>
							</div>
					...
					<div class="row row-sm">
						...
						<div class="col-6 col-sm-4 col-md mg-t-20 mg-sm-t-0">
							...
							<h5 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1">
								-$7.98 <small class="tx-danger"><i class="icon ion-md-arrow-down"></i></small>
							</h5>
						</div>
						<!-- col -->
					...
					<div class="row no-gutters">
						<div class="col col-sm-6 col-lg">
							<div class="crypto">
								...
								<div class="pos-absolute b-5 l-20 tx-medium">
									<label class="tx-9 tx-uppercase tx-sans tx-color-03"> <a href="#" class="link-01 tx-semibold">12</a> USD Markets
									</label> <label class="tx-9 tx-uppercase tx-sans tx-color-03 mg-l-10"> <a href="#" class="link-01 tx-semibold">81</a> ETH Markets
									</label>
								</div>
							</div>
							<!-- crypto -->
						...
						<div class="col col-sm-6 col-lg bd-t bd-sm-t-0 bd-sm-l">
							<div class="crypto">
								...
								<!-- chart-twelve -->
								<div class="pos-absolute b-5 l-20 tx-medium">
									<label class="tx-9 tx-uppercase tx-sans tx-color-03"> <a href="#" class="link-01 tx-semibold">11</a> USD Markets
									</label> <label class="tx-9 tx-uppercase tx-sans tx-color-03 mg-l-10"> <a href="#" class="link-01 tx-semibold">74</a> BCH Markets
									</label>
								</div>
							</div>
							<!-- crypto -->
						...
						<div class="col col-sm-6 col-lg bd-t bd-lg-t-0 bd-lg-l">
							<div class="crypto">
								...
								<!-- chart-twelve -->
								<div class="pos-absolute b-5 l-20 tx-medium">
									<label class="tx-9 tx-uppercase tx-sans tx-color-03"> <a href="#" class="link-01 tx-semibold">6</a> USD Markets
									</label> <label class="tx-9 tx-uppercase tx-sans tx-color-03 mg-l-10"> <a href="#" class="link-01 tx-semibold">42</a> LTC Markets
									</label>
								</div>
							</div>
							<!-- crypto -->
						...
						<div class="col col-sm-6 col-lg bd-t bd-lg-t-0 bd-sm-l">
							<div class="crypto">
								...
								<div class="pos-absolute b-5 l-20 tx-medium">
									<label class="tx-9 tx-uppercase tx-sans tx-color-03"> <a href="#" class="link-01 tx-semibold">6</a> USD Markets
									</label> <label class="tx-9 tx-uppercase tx-sans tx-color-03 mg-l-10"> <a href="#" class="link-01 tx-semibold">31</a> DASH Markets
									</label>
								</div>
							</div>
							<!-- crypto -->
			...
			<div class="card">
				...
				<div class="card-body pd-x-20 pd-b-10">
					...
					<h3 class="tx-26 tx-normal tx-rubik tx-spacing--2 mg-b-5">
						26.00453100 <small class="text-muted tx-light">BTC</small>
					</h3>
					...
					<ul class="list-group list-group-flush mg-b-0 tx-13">
						<li class="list-group-item pd-x-0 d-flex justify-content-between"><span class="tx-medium">Received Bitcoin</span> <span class="tx-rubik">+0.00003998 BTC</span></li>
						<li class="list-group-item pd-x-0 d-flex justify-content-between"><span class="tx-medium">Sent Bitcoin</span> <span class="tx-rubik">-0.01570525 BTC</span></li>
						<li class="list-group-item pd-x-0 d-flex justify-content-between"><span class="tx-medium">Bought Ethereum</span> <span class="tx-rubik">+2.0157 ETH</span></li>
						<li class="list-group-item pd-x-0 d-flex justify-content-between"><span class="tx-medium">Bought Bitcoin</span> <span class="tx-rubik">+0.000033420 BTC</span></li>
						<li class="list-group-item pd-x-0 d-flex justify-content-between"><span class="tx-medium">Sent Bitcoin</span> <span class="tx-rubik">-0.01570525 BTC</span></li>
					</ul>
				</div>
				<!-- card-body -->
					...
					<div class="pos-absolute t-20 l-20">
						...
						<div class="d-flex align-items-baseline">
							<h2 class="tx-normal tx-rubik tx-spacing--2 mg-b-0">
								<small class="tx-color-03">$</small> 7,429.97
							</h2>
